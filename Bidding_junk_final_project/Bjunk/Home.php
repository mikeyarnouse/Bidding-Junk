    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="Home.php" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    Dropdown
                </a>
    ...
    foreach ($rows as $row)
    {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="ended.php?item=<?=$row["item_id"]?>" class="btn btn-info"> Login</a>
            </div>
        </div>
